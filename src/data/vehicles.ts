...
export const vehicles: VehicleItem[] = [
  ...
  },
  {
    ...
    imageClassName: "object-contain bg-white p-6 group-hover:scale-105",
    detailImageClassName: "object-contain bg-white p-8",
    capacity: "4 to 4.5 Ton",
  ...
  },
  {
    ...
    name: "ODC Vehicles (JCB/Trailer)",
    shortName: "ODC (JCB/Trailer)",
    desc: "Over Dimensional Cargo (ODC) vehicles are specialized transport units for cargo exceeding standard length, width, or height, including machinery, turbines, and construction components.",
    image: heavyEquipmentImg,
    fallbackImage: heavyEquipmentImg,
    capacity: "9 to 10 Ton",
    grossRange: "ODC and heavy machinery movement",
    routeSuitability: "Project-based route planning",
    bestFor: ["JCB vehicle transport", "Turbines and oversized components", "Industrial project cargo"],
    highlights: ["Low-bed trailer options", "Extendable flatbed support", "Hydraulic multi-axle handling"],
  },
  {
    slug: "40ft-trailer",
